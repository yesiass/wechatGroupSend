...
@section('content')
    <div class="row" >
        ...
        <form id="form" method="post" action="" class="form-horizontal" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="firstname" class="col-sm-2 control-label">关注后多少秒发送</label>
                <div class="col-sm-3">
                    @if(isset($data))
                        <input id="send_offset" type="number" name="send_offset" class="form-control" value="{{$data->send_offset}}"  placeholder="关注后多少秒发送">
                    @else
                        <input id="send_offset" type="number" name="send_offset" class="form-control"  placeholder="关注后多少秒发送">
                    @endif
                </div>
            </div>
            <div class="form-group">
    ...
    <script>
        $(function(){
            ...
            $("#form_button").click(function () {
                ...
                formData.append("send_offset", $('#send_offset').val());
